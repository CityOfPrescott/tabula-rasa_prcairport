...
function optionsframework_rolescheck () {
	if ( current_user_can( 'edit_theme_options_page' ) ) {
...
function optionsframework_init() {
	...
	$location = apply_filters( 'options_framework_location', array( '/inc/theme-options-inc/options.php' ) );
...
function optionsframework_page_capability( $capability ) {
	return 'edit_theme_options_page';
}
...
function optionsframework_menu_settings() {
	...
	$menu = array(
		...
		'capability' => 'edit_theme_options_page',
